...
///
/// Allows multiple threads to send messages to the same [`super::Messenger`]. Obtain
/// an instance by calling [`super::Messenger::get_messenger_interface`].
///
...
impl<C: Context> MessengerInterface<C> {
    ...
    ///
    /// **Note:** If thread-safety is not required, call [`super::Messenger::listen`]
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::get_listener_addresses()`] directly for better
    /// performance.
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::close_connection()`] directly for better
    /// performance.
    ///
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::send_to_with_context()`] directly for better
    /// performance.
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::send_to_many_with_context`] directly for better
    /// performance.
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::broadcast_with_context`] directly for better
    /// performance.
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::broadcast_except_with_context`] directly for better
    /// performance.
    ...
    ///
    /// **Note:** If thread-safety is not required, call
    /// [`super::Messenger::broadcast_except_many_with_context`] directly for
    /// better performance.
