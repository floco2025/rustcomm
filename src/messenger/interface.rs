...
///
/// Wraps a TransportInterface and adds message serialization. Multiple threads
/// can hold cloned instances to send messages to the same Messenger.
#[derive(Clone)]
...
impl MessengerInterface {
    ...
    ///
    /// **Note:** If thread-safety is not required, call `Messenger::send_to()`
