...
///
/// This macro simplifies the registration of message types by providing the
/// appropriate serializer and deserializer function pointers for bincode.
///
/// # Example
///
/// ```no_run
...
/// [`MessageRegistry`](super::MessageRegistry) via the
/// [`register_bincode_message!`] macro.
